...
#		push @local_args_end, 'LINE1:maxout'.$target->{col4}.':MaxOut'
		push @local_args_end, 'LINE1:maxout'.$target->{col2}.':MaxOut'
			unless $noo;
	}
...
#	push @args, 'LINE2:out' . $target->{col2} . ':Out'
	push @args, 'AREA:out' . $target->{col2} . ':Out',
		unless $noo;
...
#		colours => 'GREEN#00cc00,BLUE#0000ff,DARK GREEN#006600,MAGENTA#ff00ff,AMBER#ef9f4f',
		colours => 'LIME GREEN#32CD32,ROYAL BLUE#4169E1,DARK GREEN#006600,MAGENTA#ff00ff,AMBER#ef9f4f',
		legendi => '&nbsp;In:',
		legendo => '&nbsp;Out:',
		unscaled => '',
#		withpeak => '',
...
<!--   <TD><A HREF="$item.html">$itemname<BR> -->
   <TD><H3>$itemname<BR></H3><A HREF="$item.html">
